      ...
      <div className="flex flex-col gap-6 border p-5">
        <div className="flex items-center gap-3 border border-secondary bg-white">
          ...
          <input
            ...
            required
            className="w-full h-max p-2 outline-none text-black bg-transparent"
          />
        </div>
        <div className="flex items-center gap-3 border border-secondary bg-white">
          <label htmlFor="Name" className="ps-2">
          ...
          {/* <select
            ...
            required
            className="text-sm text-[#222] outline-none text-black p-2 rounded-sm"
          >
          ...
          <input
            ...
            required
            maxLength={10}
            className="w-full  p-2 rounded-sm outline-none text-black"
          />
        </div>
        <div className="flex items-center gap-3 border border-secondary bg-white">
          <label htmlFor="Name" className="ps-2">
        ...
        <div className="flex items-center gap-3 border border-secondary bg-white">
          <select
            ...
            required
            className="w-full p-2 capitalize rounded-sm outline-none text-black px-6 text-black/40"
          >
        ...
        <div className="flex gap-3 border border-secondary bg-white">
          ...
          <textarea
            ...
            rows={5}
            className="w-full p-2 rounded-sm resize-none outline-none text-black"
          />
        </div>
        <button
          type="submit"
